# 
0. 0.hello.world -> a script that prints “Hello, World”, followed by a new line to the standard output.
...
9. Duplicate last line -> a script that duplicates the last line of the file
